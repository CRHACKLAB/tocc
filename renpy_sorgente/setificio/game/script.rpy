...
image side luigi sorpresa = "side_luigi_sorpresa.png"
...
label start:
    ...
    mario "Il gelso era una grande risorsa nel medioevo, sia per l'allevamento dei bachi da seta, sia per i suoi succosi frutti."

    luigi "Andiamo alla scoperta di questo prodigioso albero!"
    ...
    mario "Vogliamo dire poi da dove deriva il suo nome?"

    luigi "Lo spiego subito!"
    ...
    show bg frutta:
        subpixel True ypos 873 zoom 0.33 

    luigi "Morus deriva dal latino morus e dal greco móron."

    luigi "Questo nome popolare derivava dal colore nero dei suoi frutti, le more. "

    luigi "Con questo nome si diffuse anche in area germanica e celtica."

    show bg setificio:
        subpixel True ypos -306 zoom 1.5 

    mario "Interessante! Ma ancora più intrigante è il suo significato. Sai nel medioevo ogni cosa aveva un suo simbolismo!"

    luigi "Bene, scopriamo il suo significato!"
    ...
    show bg sapienza:
        subpixel True ypos 1989 zoom 2.38 

    mario "Plinio lo chiamava, Albero Sapientissimo, perché era l'ultimo a sbocciare e il primo a maturare i frutti. Nell'Araldica medievale era simbolo di “prudenza”."

    show bg setificio:
        subpixel True ypos -306 zoom 1.5 

    luigi "Inoltre un albero così importante era ovviamente al centro di molte storie e leggende."

    mario "Ce le racconti?"
    ...
    mario "La più conosciuta delle leggende sul gelso è quella della principessa cinese che scoprì la seta."

    show bg marco:
        subpixel True ypos 2016 zoom 3.0 

    luigi "Nella storia abbiamo Marco Polo,il primo europeo a descrivere l'albero di gelso e il suo utilizzo nella bachicoltura!"

    show bg setificio:
        subpixel True ypos -306 zoom 1.5 

    mario "Sapevi che gli utilizzi di questa pianta erano davvero i più disparati?"
    ...
    show bg marmellata:
        subpixel True pos (0.51, 0.84) zoom 0.4 

    mario "Ad esempio con le more, dolci e succose, del gelso si preparavano conserve, confetture e distillati."

    show bg vite:
        subpixel True pos (0.5, 0.67) zoom 0.5 

    luigi "I gelsi servivano anche a sorreggere i filari della vite. Queste consociazioni si chiamavano “Vite Maritata”."
    
    show bg flore:
        subpixel True ypos 0.76 zoom 1.52 

    mario "Bevagna era ricca di alberi di gelso, il cui utilizzo era molto variegato."

    luigi "Simbolo di sapienza, i suoi fiorellini bianchi sbocciano tra aprile e maggio."
    ...
    mario "La storia della seta nasce migliaia di anni fa nell'Asia Orientale."

    luigi "Ripassiamo un po' la storia!"
    
    show bg principessa:
        subpixel True ypos 1323 zoom 1.14 

    mario "Cina, 3000 a.C. L'imperatrice Xi Ling Shi, trova un bozzolo di un baco da seta nel tè che stava bevendo sotto a un gelso."
    
    show bg tee:
        subpixel True pos (0.5, 774) zoom 1.52 

    luigi "Grazie al calore della bevanda l'imperatrice riuscì a tirare fuori un filo lunghissimo. Il primo filo di seta della storia! Nasce la leggenda."
    
    show bg storia:
        subpixel True pos (0.5, 738) zoom 0.95 

    mario "Oltre al mito però, c'è la storia. I Cinesi furono effettivamente i primi a produrre e commerciare la seta per millenni. Il più antico reperto serico risale a ben 5.500 anni fa!"

    show bg marco:
        subpixel True ypos 2016 zoom 3.0

    luigi "Il giovane scopritore veneziano, Marco Polo, passò quasi 25 anni in Cina. Nel suo libro Il Milione, ci parla della produzione della seta,come di un'arte molto antica."

    mario "Ma ciò che stupì davvero il veneziano, fu la carta moneta. Una banconota di seta, che ci descrive nel libro. Per produrla utilizzavano la corteccia del gelso."

    show bg setificio:
        subpixel True ypos -306 zoom 1.5 

    mario "Quindi dalla Cina al resto del mondo..."

    luigi "In un batter d'occhio!"
    ...
    show bg esercito:
        subpixel True pos (0.5, 720) zoom 1.01 

    mario "Il segreto di un'arte custodita per millenni, finisce con la dinastia Han."

    luigi "Il furto fu messo a segno dai Bizantini nel 500 d.C. Come? Importando i bachi da seta e i semi di gelso."
    
    show bg kimono:
        subpixel True ypos 756 zoom 1.51 

    mario "La seta arriva dalla Cina anche in Giappone dove si svilupparono tecniche raffinatissime."

    luigi "La seta giapponese è arrivata ad essere la più pregiata e costosa al mondo!"

    show bg setificio:
        subpixel True ypos -306 zoom 1.5 

    mario "E siamo arrivati al Medioevo..."

    luigi "Tardi, però... “meglio tardi che mai”!"
    ...
    show bg italia:
        subpixel True ypos 846 zoom 1.51 

    mario "Dobbiamo attendere il XIII secolo per vedere la seta in Italia!"

    luigi "Il primo approdo è in Sicilia, con l'espansione del mondo islamico."

    mario "Da quel momento l'Italia diventa il centro europeo più importante nella produzione della seta."

    show bg setificio:
        subpixel True ypos -306 zoom 1.5 

    luigi "E da lì non ci siamo più fermati!"

    mario "Ancora di più! Siamo diventati i primi produttori di seta!"
    ...
    show bg industria:
        subpixel True ypos 792 zoom 1.51 

    mario "La seta ha avuto un ruolo cruciale nello sviluppo economico italiano."

    luigi "Fino al XIX secolo l'Italia era il primo produttore di seta greggia, insieme a Cina e Giappone."

    show bg bevagna:
        subpixel True ypos 1062 zoom 0.48 

    mario "In Umbria la gelsobachicoltura era diffusa  soprattutto nella zona di Bevagna, dove il Bombyx mori, cioè il bruco o baco da seta, veniva nutrito con foglie di gelso tritate finemente."

    show bg setificio:
        subpixel True ypos -306 zoom 1.5 

    luigi "Ma il glorioso periodo finirà con la modernità."

    mario "Che peccato! Per quale motivo?"
    ...
    luigi "La bachicoltura inizia a scomparire tra le due guerre, soprattutto dopo il secondo conflitto."
