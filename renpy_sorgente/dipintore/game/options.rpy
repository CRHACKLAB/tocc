...
## Flag utile in fase di sviluppo per ricaricare il gioco a caldo
define config.developer = True

## Fondamentali ################################################################

## Livelli
## Aggiunge un livello personalizzato sotto il livello dell'interfaccia.
define config.layers = ['master', 'transient', 'lights', 'rightmostcharacter', 'leftmostcharacter','screens', 'overlay']
...
define config.name = _("Dipintore dev")
...
define build.name = "Dipintoredev"
...
define config.save_directory = "Dipintoredev-1717583770"
